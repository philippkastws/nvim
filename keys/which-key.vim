...
let g:which_key_map['h'] = [ ':Telescope command_history'                           , 'Command history (:Telescope command_history)']
"let g:which_key_map['m'] = [ ':call WindowSwap#EasyWindowSwap()'  , 'move window' ]
let g:which_key_map['ww'] = [ ':Windows', 'search windows']
let g:which_key_map['w'] = [ '<C-W>w', 'next window']
let g:which_key_map['f'] = [ ':Telescope find_files', 'search files' ] " [ ':Files', 'search files' ]
let g:which_key_map['F'] = [ ':Telescope find_files hidden=true no_ignore=true', 'search files (incl hidden)' ]
...
let g:which_key_map['rg'] = [ ':Rg', 'grep text with rg' ]
let g:which_key_map['o'] = [ ':Telescope oldfiles', 'recent files' ]
let g:which_key_map['O'] = [ ':Startify', 'start page' ]
let g:which_key_map['G'] = [ ':Telescope live_grep hidden=true glob_pattern=*', 'grep text (incl hidden)' ]
...
let g:which_key_map['XX'] = [ ':Gitsigns reset_hunk', 'Undo hunk' ]
let g:which_key_map['PP'] = [ ':Gitsigns preview_hunk', 'Previgitsigns.preview_hunkew hunk (<leader>hp)' ]
" let g:which_key_map['GG'] = [ ':Telescope git_status', 'Git status' ]
let g:which_key_map['b'] = [ ':Telescope buffers', 'Show buffers' ]
let g:which_key_map['B'] = [ ':Telescope current_buffer_fuzzy_find', 'Buffer fuzzy find' ]
...
let g:which_key_map.X = {
      ...
      \ 's' : ["1<C-g>", 'full file path (1 ctrl+g)'],
