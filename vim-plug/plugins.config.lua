...
pcall(function()
  require'nvim-treesitter'.setup {
    ...
    ensure_installed = { "c", "lua", "vim", "vimdoc", "typescript", "javascript", "jsx", "tsx", "css", "scss", "gitcommit", "diff" },
...
pcall(function()
  ...
  if require("nvim-tree.api").tree.is_visible() then
    ...
    { "<leader>O", "<cmd>:Yazi<cr>", desc = "Start Browser", mode = "n" },
    ...
    { "<leader>dn", "<cmd>lua MiniDiff.toggle_overlay()<cr>", desc = "Mini diff inline", mode = "n" },
    { "<leader>do", "<cmd>DiffviewOpen origin/HEAD...HEAD<cr>", desc = "Diff against master/main branch", mode = "n" },
    { "<leader>dp", "<cmd>DiffviewOpen --ignore-space-change origin/HEAD...HEAD<cr>", desc = "Diff against master/main branch ignore space", mode = "n" },
